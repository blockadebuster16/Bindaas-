        ...
        {['splitLeft', 'splitRight'].map((side) => {
          ...
          return (
            <Link to={item.link || '#'} key={side} className="relative group block overflow-hidden bg-[#f5f5f5] w-full border-b md:border-b-0 border-white/20">
               ...
               {/* Bottom Black Bar */}
               <div className="bg-bindas-onyx text-white px-6 py-5 flex justify-between items-center z-10 relative border-t-2 border-transparent group-hover:border-white transition-colors">
