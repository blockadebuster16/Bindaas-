        ...
        <footer className="bg-[#111111] text-white border-t border-[#2A2A2A] font-sans relative overflow-hidden">
            ...
            <div className="border-b border-[#2A2A2A] bg-[#161616] py-5 px-6 md:px-12">
                <div className="max-w-[1440px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-4">
                    <div className="text-center lg:text-left space-y-0.5">
                        <span className="text-[#FFD017] font-bold uppercase tracking-[0.25em] text-[9px]">
                    ...
                    <form onSubmit={handleSubscribe} className="w-full lg:w-auto flex flex-col sm:flex-row gap-2.5 max-w-sm">
                        <input
                            ...
                            className="bg-[#222222] border border-[#333333] text-white px-4 py-2 text-xs focus:outline-none focus:border-[#FFD017] flex-1 rounded-full placeholder:text-slate-500 font-medium"
                            required
                        />
                        <button
                            type="submit"
                            disabled={submitting}
                            className="btn-pill whitespace-nowrap px-6 py-2 text-[10px] font-bold uppercase tracking-[0.2em] bg-[#FFD017] text-[#111111] hover:bg-white hover:text-[#111111]"
                        >
                ...
                {status.message && (
                    <div className="max-w-[1440px] mx-auto mt-3 text-center lg:text-right">
                        <span className={`text-[10px] font-bold uppercase tracking-widest ${status.type === 'success' ? 'text-[#FFD017]' : 'text-rose-400'}`}>
                            {status.message}
                        </span>
                    </div>
                )}
            ...
            <div className="max-w-[1440px] mx-auto px-6 md:px-12 pt-10 pb-8 grid grid-cols-1 md:grid-cols-4 gap-8 items-start">
                ...
                <div className="text-left">
                    <h5 className="text-[10px] text-[#FFD017] font-bold uppercase tracking-[0.25em] mb-6">Order Support</h5>
                    <ul className="text-xs text-slate-300 space-y-3 font-medium">
                        <li><Link to="/profile" className="hover:text-[#FFD017] transition-colors">Make a Return / Exchange</Link></li>
                        <li><Link to="/terms" className="hover:text-[#FFD017] transition-colors">Refund & Exchange Policy</Link></li>
                        <li><Link to="/profile" className="hover:text-[#FFD017] transition-colors">Track Your Order</Link></li>
                        <li><Link to="/terms" className="hover:text-[#FFD017] transition-colors">Shipping Policy</Link></li>
                        <li><Link to="/faq" className="hover:text-[#FFD017] transition-colors">FAQ's</Link></li>
                        <li><Link to="/terms" className="hover:text-[#FFD017] transition-colors">Terms of Service</Link></li>
                    </ul>
                </div>

                {/* 2. We Are BiNDAAS! (Next) */}
                <div className="text-left">
                    <h5 className="text-[10px] text-[#FFD017] font-bold uppercase tracking-[0.25em] mb-6">We Are BiNDAAS!</h5>
                    <ul className="text-xs text-slate-300 space-y-3 font-medium">
                        <li><Link to="/heritage" className="hover:text-[#FFD017] transition-colors">Our Heritage Story</Link></li>
                        <li><Link to="/contact" className="hover:text-[#FFD017] transition-colors">Walk-in Stores</Link></li>
                        <li><Link to="/sustainability" className="hover:text-[#FFD017] transition-colors">Sustainability & Craft</Link></li>
                        <li><Link to="/contact" className="hover:text-[#FFD017] transition-colors">Collaborations</Link></li>
                        <li><Link to="/contact" className="hover:text-[#FFD017] transition-colors">Careers & Media</Link></li>
                        <li><Link to="/privacy" className="hover:text-[#FFD017] transition-colors">Privacy Policy</Link></li>
                    </ul>
                </div>

                {/* 3. Connect With Us (Last text column) */}
                <div className="text-left space-y-4">
                    <h5 className="text-[10px] text-[#FFD017] font-bold uppercase tracking-[0.25em]">Connect With Us</h5>
                    ...
                    <div className="space-y-2 text-xs text-slate-300 font-medium pt-1">
                        <p className="flex items-center gap-2">
                            ...
                            <a href="tel:+918448441388" className="hover:text-[#FFD017] transition-colors">+91 84484 41388</a>
                        </p>
                        <p className="flex items-center gap-2">
                            <span className="text-slate-500 text-[10px] uppercase font-bold">WhatsApp:</span>
                            <a href="https://wa.me/918448441388" target="_blank" rel="noopener noreferrer" className="hover:text-[#FFD017] transition-colors">+91 84484 41388</a>
                        </p>
                    </div>
