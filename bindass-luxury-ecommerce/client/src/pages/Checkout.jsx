...
const Checkout = () => {
    ...
    // 1. Seed totals from CartContext
    useEffect(() => {
            ...
            <main className="max-w-7xl mx-auto px-6 py-12">
                ...
                <div className="mb-12 max-w-xl mx-auto">
                    <div className="flex items-center justify-between relative">
                        ...
                        <div className="flex flex-col items-center gap-2 bg-background-light dark:bg-background-dark pr-8">
                        ...
                        <div className="flex flex-col items-center gap-2 bg-background-light dark:bg-background-dark pl-8 opacity-50">
                            <div className="w-10 h-10 rounded-full bg-white dark:bg-slate-800 border-2 border-primary/20 text-zinc-400 flex items-center justify-center font-bold">2</div>
                            ...
                            <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-1">
                                        <input 
                                            ...
                                            className={`w-full bg-white dark:bg-slate-800 border ${errors.firstName ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                    ...
                                    <div className="space-y-1">
                                        <input 
                                            ...
                                            className={`w-full bg-white dark:bg-slate-800 border ${errors.lastName ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                ...
                                <div className="space-y-1">
                                    <input 
                                        ...
                                        className={`w-full bg-white dark:bg-slate-800 border ${errors.addressLine1 ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                    <div className="space-y-1">
                                        <input 
                                            ...
                                            className={`w-full bg-white dark:bg-slate-800 border ${errors.city ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                            placeholder="City" 
                                        />
                                    ...
                                    <div className="space-y-1">
                                        <input 
                                            ...
                                            className={`w-full bg-white dark:bg-slate-800 border ${errors.pincode ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                            placeholder="Pincode" 
                                        />
                                    ...
                                    <select 
                                        ...
                                        className="w-full border border-slate-300 dark:border-slate-700 rounded-lg p-4 bg-white dark:bg-slate-800 outline-none text-slate-900 dark:text-slate-100"
                                    >
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div className="space-y-1">
                                        <input 
                                            ...
                                            className={`w-full bg-white dark:bg-slate-800 border ${errors.email ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                            placeholder="Email" 
                                            type="email" 
                                        />
                                    ...
                                    <div className="space-y-1">
                                        <input 
                                            ...
                                            className={`w-full bg-white dark:bg-slate-800 border ${errors.phone ? 'border-red-500' : 'border-slate-300 dark:border-slate-700'} rounded-lg p-4 outline-none focus:ring-1 focus:ring-primary text-slate-900 dark:text-slate-100`} 
                                            placeholder="Phone" 
                                            type="tel" 
                                        />
                                ...
                                <button 
                                    className="w-full bg-[#10221c] text-white font-bold py-5 rounded-lg uppercase tracking-widest text-xs hover:bg-black dark:hover:bg-slate-950 transition-all active:scale-[0.98]" 
                                    type="submit"
                                >
                                    Continue to Payment
                                </button>
                        ...
                        <div className="sticky top-28 bg-white dark:bg-slate-900 p-8 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
                            ...
                            <div className="space-y-4 mb-8 max-h-[250px] overflow-y-auto custom-scrollbar pr-2">
                                {cartItems.map((item, index) => (
                                    <div key={index} className="flex gap-4 border-b border-slate-50 dark:border-slate-800 pb-4">
                                        <div className="w-16 h-20 bg-slate-50 dark:bg-slate-800 rounded overflow-hidden flex-shrink-0">
                                            <img src={item.image} className="w-full h-full object-cover" alt={item.name} />
                                        </div>
                                        <div className="flex-1 py-1">
                                            <h4 className="text-[11px] font-bold uppercase dark:text-white truncate leading-tight">{item.name}</h4>
                                            <p className="text-[9px] text-slate-400 mt-0.5">SIZE: {item.size} • QTY: {item.quantity}</p>
                                            <div className="text-[11px] font-bold mt-2 dark:text-white">₹{(item.price || 0).toLocaleString()}</div>
                                        </div>
                                    </div>
                                ))}
                            </div>
                            ...
                            {/* Shipping Method */}
                            <div className="mb-6 border-t dark:border-slate-800 pt-6">
                                <p className="text-[10px] font-bold text-gray-500 uppercase tracking-widest mb-3">Shipping Method</p>
                                <div className="space-y-2">
                                    {['Air', 'Surface'].map(m => (
                                        <label key={m} className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${shippingMethod === m ? 'border-gray-900 dark:border-white bg-gray-50 dark:bg-slate-800' : 'border-slate-200 dark:border-slate-800 hover:border-gray-400'}`}>
                                            <div className="flex items-center gap-2">
                                                <input type="radio" name="shippingMethod" value={m} checked={shippingMethod === m} onChange={() => setShippingMethod(m)} className="accent-gray-900 dark:accent-white" />
                                                <span className="text-xs font-semibold text-gray-800 dark:text-slate-200">{m} Shipping</span>
                                            </div>
                                            <span className="text-xs font-medium text-gray-500">{m === 'Air' ? 'Faster' : 'Standard'}</span>
                                        </label>
                                    ))}
                                    {storeConfig?.codEnabled && (
                                        <label className={`flex items-center justify-between p-3 rounded-lg border cursor-pointer transition-all ${isCOD ? 'border-amber-400 bg-amber-50 dark:bg-amber-950/30' : 'border-slate-200 dark:border-slate-800 hover:border-amber-300'}`}>
                                            <div className="flex items-center gap-2">
                                                <input type="checkbox" checked={isCOD} onChange={e => setIsCOD(e.target.checked)} className="accent-amber-500" />
                                                <span className="text-xs font-semibold text-gray-800 dark:text-slate-200">Cash on Delivery</span>
                                            </div>
                            ...
                            {zone?.isInternational && zone?.duty_note && (
                                <div className="mb-4 p-3 rounded-lg bg-amber-50 dark:bg-amber-950/20 border border-amber-100 dark:border-amber-900/50">
                                    ...
                                    <p className="text-[10px] text-amber-700 dark:text-amber-400 leading-relaxed">{zone.duty_note}</p>
                                </div>
                            )}
                            ...
                            <div className="mb-6 border-t dark:border-slate-800 pt-6">
                                {appliedCoupon ? (
                                    <div className="flex items-center justify-between bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-100 dark:border-emerald-900/50 p-3 rounded-lg">
                                        <div className="flex items-center gap-2">
                            ...
                            <div className="space-y-3 border-t dark:border-slate-800 pt-6">
                                <div className="flex justify-between text-[13px] text-slate-500">
                                    <span>Subtotal</span>
                                    <span className="dark:text-white font-semibold">₹{(checkoutTotals?.subtotal || 0).toLocaleString()}</span>
                                </div>
                                
                                {checkoutTotals?.discount > 0 && (
                                    <div className="flex justify-between text-[13px] text-emerald-600 dark:text-emerald-400 font-medium">
                                        <span>Discount</span>
                                ...
                                <div className="flex justify-between text-[13px] text-slate-500">
                                    ...
                                    {checkoutTotals?.shippingTotal > 0 
                                        ? <span className="dark:text-white font-semibold">₹{checkoutTotals.shippingTotal.toLocaleString()}</span>
                                        : <span className="text-emerald-600 dark:text-emerald-400 font-bold uppercase text-[9px] tracking-widest">Complimentary</span>
                                    }
                                </div>
                                {isCOD && checkoutTotals?.codFee > 0 && (
                                    <div className="flex justify-between text-[13px] text-amber-600 dark:text-amber-400">
                                        <span>COD Fee</span>
                                ...
                                <div className="flex justify-between text-[13px] text-slate-500">
                                    ...
                                    <span className="dark:text-white font-semibold">₹{(checkoutTotals?.cgst || 0).toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between text-[13px] text-slate-500">
                                    <span>SGST ({storeConfig?.sgst ?? 9}%)</span>
                                    <span className="dark:text-white font-semibold">₹{(checkoutTotals?.sgst || 0).toLocaleString()}</span>
                                </div>
                                <div className="flex justify-between text-lg font-bold pt-4 border-t dark:border-slate-800 mt-4 dark:text-white items-end">
                                    <span className="uppercase text-xs tracking-widest pb-1">Total</span>
                                    <span className="text-2xl font-black text-[#10221c] dark:text-emerald-400">₹{(checkoutTotals?.totalAmount || 0).toLocaleString()}</span>
                                </div>
                            </div>
                        </div>
                    </aside>
