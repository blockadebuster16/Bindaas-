                ...
                <div className="bg-white p-8 md:p-16 rounded-3xl border border-slate-100 shadow-sm transition-all hover:shadow-xl hover:shadow-[#10221c]/5">
                    ...
                    <div className="prose prose-slate max-w-none space-y-12">
                        ...
                        <section className="space-y-4">
                            <p className="text-sm font-bold text-[#10221c] uppercase tracking-wide">Essential Reading</p>
                        ...
                        <section className="space-y-6">
                            <h3 className="text-xl font-black text-[#10221c] uppercase tracking-tighter border-b border-slate-50 pb-4">
                        ...
                        <section className="space-y-6">
                            <h3 className="text-xl font-black text-[#10221c] uppercase tracking-tighter border-b border-slate-50 pb-4">
                                2. HOW TO AVAIL AND USE THE SERVICES?
                            </h3>
                            <div className="space-y-4">
                                <p className="text-sm font-bold text-[#10221c]">License Grant</p>
                                <p className="text-slate-600 leading-relaxed text-sm">
                                    We grant to you a personal, limited, revocable, non-exclusive and non-transferable license to access the Platform and use the Services only as expressly permitted in these Terms. You shall not access the Platform and/or use the Services for any illegal purpose or in any manner inconsistent with these Terms.
                                </p>
                                <p className="text-sm font-bold text-[#10221c]">Account Security</p>
                                <p className="text-slate-600 leading-relaxed text-sm">
                                    You shall be solely responsible for the confidentiality, safety and security of the user account opened by you. You must keep your password confidential and you are solely responsible for maintaining the confidentiality and security of your account, all changes and updates submitted through your account, and all activities that occur in connection with your account.
                                </p>
                            </div>
                        </section>
                        ...
                        <section className="space-y-6">
                            ...
                            <p className="text-slate-600 leading-relaxed text-sm">
                                This Agreement will be governed by the laws of India without regard to conflicts of law provisions thereof. All disputes relating to or arising out of this Agreement shall be resolved in the courts located in Mumbai, and the parties hereby consent to the jurisdiction of such courts.
                            </p>
                        </section>

                        <section className="pt-10 border-t border-slate-100 flex flex-col md:flex-row justify-between gap-8">
                            <div>
                                <h4 className="text-xs font-black uppercase tracking-widest text-[#10221c] mb-4">Grievance Officer</h4>
                            ...
                            <div className="text-left md:text-right">
                                <h4 className="text-xs font-black uppercase tracking-widest text-[#10221c] mb-4">Operational Address</h4>
                                <p className="text-xs text-slate-500 leading-relaxed">
                                    Unit No. 224, Tantia Jogani Industrial Estate<br/>
