                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-5 lg:gap-6 items-start relative">
                    ...
                    <div className="lg:col-span-4">
                        ...
                        <div className="flex justify-between items-start gap-4">
                            <div>
                                <h1 className="text-xl md:text-2xl font-extrabold tracking-tight text-bindas-onyx leading-tight">
                                    {product.name}
                                </h1>
                        ...
                        <div className="space-y-3 pt-2 border-t border-slate-200/60">
                            <div className="flex justify-between items-center text-xs">
                                <span className="font-bold text-bindas-onyx uppercase tracking-wider text-[11px]">Size</span>
                                <button
                                ...
                                {availableSizes.map(size => (
                                    <button
                                        ...
                                        className={`px-5 py-2.5 rounded-full text-xs font-bold transition-all border ${selectedSize === size
                                            ? 'bg-bindas-onyx text-white border-bindas-onyx shadow-md'
                                            : 'bg-white text-bindas-onyx border-slate-200 hover:border-black'
                                            }`}
                                    >
                                        {size}
                                    </button>
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 pt-2">
                            <button
                                ...
                                className="flex-1 py-3.5 px-6 rounded-full border border-slate-300 bg-white text-bindas-onyx hover:bg-slate-100 font-bold uppercase tracking-[0.15em] text-[11px] transition-all duration-200 text-center"
                            >
                                ADD TO BAG
                            </button>
                            <button
                                onClick={handleBuyNow}
                                className="flex-1 py-3.5 px-6 rounded-full bg-bindas-onyx text-white hover:bg-neutral-800 font-bold uppercase tracking-[0.15em] text-[11px] transition-all duration-200 text-center shadow-lg"
                            >
                                BUY NOW
                            </button>
                        </div>
                            ...
                            <div className="flex border-b border-slate-200 gap-6 text-xs font-bold uppercase tracking-wider">
                                <button
                                    ...
                                    className={`pb-2.5 transition-all ${activeTab === 'details'
                                        ? 'border-b-2 border-bindas-onyx text-bindas-onyx'
                            ...
                            <div className="text-xs text-slate-600 space-y-4 font-light leading-relaxed pt-2">
                                {activeTab === 'details' && (
                                    <div className="space-y-3">
                                        <div>
                                            <p className="font-bold text-bindas-onyx uppercase tracking-wider text-[10px] mb-1">Details</p>
                                        ...
                                        <div className="pt-2 border-t border-slate-200/40">
                                            <p className="font-bold text-bindas-onyx uppercase tracking-wider text-[10px] mb-1">Description</p>
                                ...
                                {activeTab === 'washcare' && (
                                    <div className="space-y-2">
                                        <p className="font-bold text-bindas-onyx uppercase tracking-wider text-[10px]">Care Instructions</p>
                                ...
                                {activeTab === 'shipping' && (
                                    <div className="space-y-2">
                                        <p className="font-bold text-bindas-onyx uppercase tracking-wider text-[10px]">Shipping & Returns</p>
                                        <p className="text-[11px] text-slate-600 font-normal">
                                ...
                                {activeTab === 'reviews' && (
                                    <div className="space-y-4">
                                        ...
                                        <div className="flex items-center gap-2 bg-white p-3 rounded-xl border border-slate-200">
                                            ...
                                            <span className="font-bold text-xs text-bindas-onyx">
                                                ...
                                                reviewsData.reviews.map(review => (
                                                    <div key={review._id} className="bg-white p-3 rounded-xl border border-slate-100 text-[11px]">
                                                        <div className="flex justify-between items-center mb-1">
                                                            <span className="font-bold text-bindas-onyx">{review.userName}</span>
                                        ...
                                        <div className="bg-white p-4 rounded-xl border border-slate-200 pt-3">
                                            <h4 className="text-[10px] font-bold uppercase tracking-wider mb-2 text-bindas-onyx">Write a Review</h4>
