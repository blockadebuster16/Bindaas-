...
const ProductDetail = () => {
    ...
    // Clean structural helper for structural metrics tracking
    const handleAccordionToggle = (sectionId, analyticalName) => {
        const isOpening = openAccordion !== sectionId;
        setOpenAccordion(isOpening ? sectionId : '');
        
        if (isOpening && clarity && typeof clarity.event === 'function') {
            clarity.event('accordion_opened', { section_name: analyticalName });
        }
    };
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 md:gap-16">
                    ...
                    <div className="lg:col-span-5 space-y-8">
                        <div>
                            ...
                            <div className="flex items-center gap-1 cursor-pointer" onClick={() => handleAccordionToggle('reviews', 'Customer Reviews')}>
                                <div className="flex">
                                    {[1, 2, 3, 4, 5].map(i => (
                        ...
                        <div className="border-t border-slate-200 dark:border-primary/10 mt-12">
                            ...
                            <div className="border-b border-slate-200 dark:border-primary/10">
                                <button
                                    onClick={() => handleAccordionToggle('desc', 'Product Description')}
                            ...
                            <div className="border-b border-slate-200 dark:border-primary/10">
                                <button
                                    onClick={() => handleAccordionToggle('materials', 'Materials & Care')}
                                    className="w-full flex justify-between items-center py-6 text-left group"
                                >
                                    <span className="text-sm font-bold uppercase tracking-widest group-hover:text-[#10b981] transition-colors text-[#10221c]">
                                        Materials & Care
                            ...
                            <div className="border-b border-slate-200 dark:border-primary/10">
                                <button
                                    onClick={() => handleAccordionToggle('integrity', 'Materials Integrity')}
                                    className="w-full flex justify-between items-center py-6 text-left group"
                                >
                                    <span className="text-sm font-bold uppercase tracking-widest group-hover:text-[#10b981] transition-colors text-[#10221c]">
                                        Materials Integrity
                            ...
                            <div className="border-b border-slate-200 dark:border-primary/10">
                                <button
                                    onClick={() => handleAccordionToggle('ship', 'Shipping & Returns')}
                                    className="w-full flex justify-between items-center py-6 text-left group"
                                >
                                    <span className="text-sm font-bold uppercase tracking-widest group-hover:text-[#10b981] transition-colors text-[#10221c]">
                                        Shipping & Returns
                            ...
                            <div className="border-b border-slate-200 dark:border-primary/10">
                                <button
                                    onClick={() => handleAccordionToggle('reviews', 'Customer Reviews')}
                                    className="w-full flex justify-between items-center py-6 text-left group"
                                >
                                    <span className="text-sm font-bold uppercase tracking-widest group-hover:text-[#10b981] transition-colors text-[#10221c]">
                                        Customer Reviews
