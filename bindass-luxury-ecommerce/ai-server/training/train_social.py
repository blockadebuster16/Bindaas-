"""
Train Social Specialist SVM
===========================
Multi-class SVM for social intents
"""
...
def main():
    csv_path = DATA_DIR / "social_intents.csv"
    ...
    if USE_GPU:
        try:
            ...
            svm = CalibratedClassifierCV(LinearSVC(C=5.0, max_iter=2000), cv=3)
    ...
    print("\n--- Social SVM Classification Report ---")
    print(classification_report(y_test, y_pred))

    joblib.dump(svm, MODELS_DIR / "social_svm.joblib")
    print(f"[v] Social SVM saved to {MODELS_DIR}")
